...
X_train, X_test, ground_train, ground_test = train_test_split(altered_images_arr, real_images_arr, test_size=0.2, random_state=42)
...
autoencoder.fit(X_train, ground_train, epochs=200, batch_size=32, validation_data=(X_test, ground_test))
